...
def build_train_samples_dict():
    ...
    # 载入数据
    df = build_samples.build_data_frame_for_correlation_analysis('2016050510', '2019050513')
...
def build_train_targets_array():
    ...
    # 载入数据
    data = build_samples.build_data_frame_for_correlation_analysis('2016050510', '2019050513')
